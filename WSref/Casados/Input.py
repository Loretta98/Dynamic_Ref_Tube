...
DHreact = np.sum(np.multiply(nu_,dH_formation_i),axis=1).transpose()                                 # Enthalpy of reaction              [kJ/mol]
...
velocity = VolFlow_R1/Aint                     #/Aint ### oppure potrebbe essere definito come u 
